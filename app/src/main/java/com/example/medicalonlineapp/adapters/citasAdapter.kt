...
class citasAdapter  (mCtx: Context, pacientesList:List<Paciente>, activity: Activity) :
    RecyclerView.Adapter<citasAdapter.ProductViewHolder>()  {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) : ProductViewHolder{
        ...
        val view: View = inflate.inflate(R.layout.card_view_citas_anteriores, parent,false)
